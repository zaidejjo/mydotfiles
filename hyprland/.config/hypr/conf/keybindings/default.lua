...
hl.bind(
	mainMod .. " + period",
	hl.dsp.exec_cmd("~/.config/hypr/scripts/rofi-symbols.sh"),
	{ description = "Fast Emoji & Nerd Icons Picker" }
)
...
hl.bind(
	"PRINT",
	hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --instant-area-copy"),
	{ description = "Take an instant area screenshot to clipboard" }
)
hl.bind(
	mainMod .. " + ALT + F",
...
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd("~/.config/hypr/scripts/cliphist-rofi.sh"),
	{ description = "Open Rofi Clipboard with Image Preview" }
)
...
hl.bind(" + CTRL + L", hl.dsp.exec_cmd("hyprlock"), { description = "Lock screen" })
...
hl.bind(
	mainMod .. " + CTRL + down",
	hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-scratchpad-window"),
	{ description = "Toggle window down / hide" }
)
